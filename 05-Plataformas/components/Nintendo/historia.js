...
export default function Historia() {
    return (
        <View style={ styles.container }>
            <Text style={ styles.title }>História do Nintendo Entertainment System</Text>
            <Image source={Console} style={ styles.imageHistoria }/>
            <Text style={ styles.description }>Um dos consoles mais emblemáticos da Nintendo até hoje foi lançado em 1983 no Japão com o nome de Famicom (Family Computer), mas só em 1985 o console chegou aos Estados Unidos, com um visual totalmente reformulado e um novo nome, Nintendo Entertainment System (NES).
